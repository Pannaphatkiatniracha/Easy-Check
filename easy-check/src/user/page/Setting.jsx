    ...
    return (
        <div className="app-container">
            ...
            <div className="d-flex justify-content-center mt-5">
                <div className="w-75 p-2 rounded bg-warning d-flex align-items-center fw-semibold hover:scale-105 transition-all duration-200 ease-in-out">
            ...
            <Link to="/profile" className='text-decoration-none d-block'>            
                <div className="d-flex justify-content-center mt-3">
                    <div className="w-75 p-2 rounded bg-warning d-flex align-items-center fw-semibold text-dark hover:scale-105 transition-all duration-200 ease-in-out">
