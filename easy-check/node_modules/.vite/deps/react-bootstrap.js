import {
  ...
  Form_default,
  useCol
} from "./chunk-M3BZOVXK.js";
import {
  ProgressBar_default
} from "./chunk-7SAYDBVQ.js";
import {
  CardBody_default,
  CardFooter_default,
...
import {
  ...
  useWaitForDOMRef
} from "./chunk-2HDJNHSA.js";
import {
  divWithClassName_default
} from "./chunk-6A3PTCEQ.js";
import {
  InputGroup_default
} from "./chunk-KSIK2ZX3.js";
import "./chunk-DTCYSEJG.js";
import {
  CarouselCaption_default,
  CarouselItem_default,
  Carousel_default,
  useTimeout
} from "./chunk-G7GQASYA.js";
import {
  forEach,
  map
} from "./chunk-CMDJK6BD.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
...
import {
  ...
  dataProp,
  qsa
} from "./chunk-QPXNPSSY.js";
import "./chunk-SPCTIHMT.js";
import {
  Button_default as Button_default2
} from "./chunk-BPV7UJ3C.js";
import {
  Anchor_default,
  require_browser,
  useCallbackRef,
...
} from "./chunk-GNPSILIX.js";
import {
  require_prop_types
} from "./chunk-CY2I7XHN.js";
import {
  Button_default
} from "./chunk-B6HL4D6A.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Container = React19.forwardRef(({
  ...
  return (0, import_jsx_runtime18.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames17.default)(className, fluid ? `${prefix}${suffix}` : prefix)
  });
});
...
var DropdownButton = React20.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime20.jsxs)(Dropdown_default, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime19.jsx)(DropdownToggle_default, {
    id,
    href,
    size,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime19.jsx)(DropdownMenu_default, {
    role: menuRole,
...
var Image = React21.forwardRef(({
  ...
  return (0, import_jsx_runtime21.jsx)("img", {
    ref,
    ...props,
    className: (0, import_classnames18.default)(className, fluid && `${bsPrefix}-fluid`, rounded && `rounded`, roundedCircle && `rounded-circle`, thumbnail && `${bsPrefix}-thumbnail`)
  });
});
...
var FigureImage = React22.forwardRef(({
  ...
  fluid = true,
  ...props
}, ref) => (0, import_jsx_runtime22.jsx)(Image_default, {
  ref,
  ...props,
  fluid,
...
var TabContext = React25.createContext(null);
...
var NavItem = React26.forwardRef((_ref, ref) => {
  let {
  ...
  return (0, import_jsx_runtime25.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React27.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
  ...
  return (0, import_jsx_runtime26.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime26.jsx)(NavContext_default.Provider, {
      value: {
        role,
      ...
      children: (0, import_jsx_runtime26.jsx)(Component2, Object.assign({}, props, {
...
var ListGroup = React29.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime28.jsx)(Nav_default, {
    ref,
    ...controlledProps,
    as,
...
var NavItem2 = React30.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React31.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime30.jsx)(Component2, {
    ...
    ref,
    disabled,
    className: (0, import_classnames25.default)(className, bsPrefix, disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React32.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarCollapse = React34.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
  bsPrefix = useBootstrapPrefix(bsPrefix, "navbar-collapse");
  const context3 = (0, import_react10.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime33.jsx)(Collapse_default, {
...
var NavbarToggle = React35.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime34.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime34.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react12.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react13.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var OffcanvasBody = React36.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React37.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime36.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: getChildRef(children),
    children: (status, innerProps) => React37.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames30.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var OffcanvasHeader = React38.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
  ...
  return (0, import_jsx_runtime37.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var OffcanvasTitle = React39.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime39.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return (0, import_jsx_runtime39.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React40.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react14.useCallback)((backdropProps) => (0, import_jsx_runtime39.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames33.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime39.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames33.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime41.jsxs)(import_jsx_runtime40.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime39.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime39.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React41.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context3 = (0, import_react15.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
    context3 == null || context3.onToggle == null || context3.onToggle();
    onHide == null || onHide();
  });
  return (0, import_jsx_runtime42.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React42.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React43.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
  ...
  return (0, import_jsx_runtime44.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime44.jsx)(SelectableContext_default.Provider, {
...
var NavDropdown = React44.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime46.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames36.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime45.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime45.jsx)(Dropdown_default.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Overlay2 = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime53.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime56.jsxs)(import_jsx_runtime55.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react21.cloneElement)(children, triggerProps), (0, import_jsx_runtime54.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React53.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)("li", {
    ref,
    style,
    ...
    children: (0, import_jsx_runtime58.jsxs)(Component2, {
      className: (0, import_classnames42.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime57.jsx)("span", {
...
function createButton(name, defaultValue, label = name) {
  const Button = React53.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime58.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime59.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React55.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime60.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Spinner = React59.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size,
...
var SplitButton = React60.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  children: [(0, import_jsx_runtime65.jsx)(Button_default2, {
    size,
    variant,
...
function useTabPanel(_ref) {
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context3, rest = _objectWithoutPropertiesLoose3(context3, _excluded22);
...
var TabPanel = React62.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime74.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastFade = React68.forwardRef((props, ref) => (0, import_jsx_runtime76.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToggleButton = React74.forwardRef(({
  ...
  return (0, import_jsx_runtime84.jsxs)(import_jsx_runtime83.Fragment, {
    children: [(0, import_jsx_runtime82.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime82.jsx)(Button_default2, {
      ...props,
      ref,
